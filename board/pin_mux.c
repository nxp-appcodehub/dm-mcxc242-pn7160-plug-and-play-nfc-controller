...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_NXPNCI_ConfigurePins
 * Description   : Configures PN7160 I2C and GPIO pins.
 *
 * END ****************************************************************************************************************/
void BOARD_NXPNCI_ConfigurePins(void)
{
    ...
    const port_pin_config_t i2c_pin_config = {/* Internal pull-up resistor is enabled */
                                              ...
                                              /* Low drive strength is configured */
                                              kPORT_LowDriveStrength,
                                              /* Pin is configured as I2C */
                                              kPORT_MuxAlt4};

    const port_pin_config_t gpio_pin_config = {/* Internal pull-up/down resistor is disabled */
                                               kPORT_PullDisable,
                                               /* Fast slew rate is configured */
                                               kPORT_FastSlewRate,
                                               /* Passive filter is disabled */
    ...
    PORT_SetPinConfig(PORTD, 6U, &i2c_pin_config);   /* PTD6: I2C1_SDA */
    PORT_SetPinConfig(PORTD, 7U, &i2c_pin_config);   /* PTD7: I2C1_SCL */
    PORT_SetPinConfig(PORTE, 31U, &gpio_pin_config); /* PTE31: PN7160 IRQ */
    PORT_SetPinConfig(PORTC, 8U, &gpio_pin_config);  /* PTC8: PN7160 VEN */
    PORT_SetPinConfig(PORTC, 9U, &gpio_pin_config);  /* PTC9: PN7160 REQ */
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
