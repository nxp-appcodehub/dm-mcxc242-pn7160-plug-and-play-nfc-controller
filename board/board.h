...
/*
 * PN7160 NXP-NCI interface.
 * IRQ is a data-ready input from PN7160. VEN controls hardware reset/enable.
 * REQ also maps to DWL; holding it low keeps PN7160 in normal NCI mode.
 */
#define BOARD_NXPNCI_INTERFACE_I2C
#define BOARD_NXPNCI_I2C_INSTANCE   I2C1
#define BOARD_NXPNCI_I2C_CLOCK_FREQ CLOCK_GetFreq(I2C1_CLK_SRC)
#define BOARD_NXPNCI_I2C_BAUDRATE   100000U
#define BOARD_NXPNCI_I2C_ADDR       0x28U

#define BOARD_NXPNCI_IRQ_PORT       PORTE
#define BOARD_NXPNCI_IRQ_GPIO       GPIOE
#define BOARD_NXPNCI_IRQ_PIN        31U
#define BOARD_NXPNCI_VEN_PORT       PORTC
#define BOARD_NXPNCI_VEN_GPIO       GPIOC
#define BOARD_NXPNCI_VEN_PIN        8U
#define BOARD_NXPNCI_REQ_PORT       PORTC
#define BOARD_NXPNCI_REQ_GPIO       GPIOC
#define BOARD_NXPNCI_REQ_PIN        9U
#define BOARD_NXPNCI_DWL_PORT       BOARD_NXPNCI_REQ_PORT
#define BOARD_NXPNCI_DWL_GPIO       BOARD_NXPNCI_REQ_GPIO
#define BOARD_NXPNCI_DWL_PIN        BOARD_NXPNCI_REQ_PIN
